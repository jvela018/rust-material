# Add Obstacles and Keeping score
This section talks about adding obstacles that force the dragon to navigate. The obstacles are mainly walls with gaps.

We'll introduce scores here as well.

# Starting point

Remember to update Toml file
```
[package]
name = "hello_bterm"
version = "0.1.0"
...
// create obstacle structure
struct Obstacle {
    // define x-axis location
    x: i32,
    // define center of the gap
    gap_y: i32,
    // define the size/height of the gap
    size: i32,
}

// create obstacle implementation
impl Obstacle {
